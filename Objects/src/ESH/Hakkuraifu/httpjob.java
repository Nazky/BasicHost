...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ESH.Hakkuraifu.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ESH.Hakkuraifu.httpjob.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public String _vvvvvvvvvvvvvvvvvvv7 = "";
public boolean _vvvvvvvvvvvvvvvvvvv0 = false;
...
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest _vvvvvvvvvvvvvvvvvvvv6 = null;
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse _vvvvvvvvvvvvvvvvvvvv7 = null;
public Object _vvvvvvvvvvvvvvvvvvvv0 = null;
public String _vvvvvvvvvvvvvvvvvvvvv1 = "";
public String _vvvvvvvvvvvvvvvvvvvvv2 = "";
...
public String  _vvvvvvvvvvvvvvvv6(String _link) throws Exception{
...
if ((_vvvvvvvvvvvvvvvvvvvvv2).equals("") || _link.contains(":")) { 
if (true) return _link;};
 //BA.debugLineNum = 45;BA.debugLine="Return DefaultScheme & \"://\" & Link";
if (true) return _vvvvvvvvvvvvvvvvvvvvv2+"://"+_link;
...
_vvvvvvvvvvvvvvvvvvvv6 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest();
 //BA.debugLineNum = 16;BA.debugLine="Public Response As OkHttpResponse";
_vvvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse();
 //BA.debugLineNum = 25;BA.debugLine="Public Tag As Object";
_vvvvvvvvvvvvvvvvvvvv0 = new Object();
...
_vvvvvvvvvvvvvvvvvvvvv1 = "https://invalid-url/";
 //BA.debugLineNum = 31;BA.debugLine="Public DefaultScheme As String = \"https\"";
_vvvvvvvvvvvvvvvvvvvvv2 = "https";
 //BA.debugLineNum = 32;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvv7(int _id) throws Exception{
 //BA.debugLineNum = 306;BA.debugLine="Public Sub Complete (id As Int)";
 //BA.debugLineNum = 307;BA.debugLine="taskId = id";
_vvvvvvvvvvvvvvvvvvvv5 = BA.NumberToString(_id);
 //BA.debugLineNum = 308;BA.debugLine="CallSubDelayed2(target, \"JobDone\", Me)";
__c.CallSubDelayed2(ba,_vvvvvvvvvvvvvvvvvvvv4,"JobDone",this);
 //BA.debugLineNum = 309;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvv0(String _link) throws Exception{
...
_link = _vvvvvvvvvvvvvvvv6(_link);
 //BA.debugLineNum = 255;BA.debugLine="req.InitializeDelete(Link)";
_vvvvvvvvvvvvvvvvvvvv6.InitializeDelete(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeDelete(_vvvvvvvvvvvvvvvvvvvvv1);
 };
 //BA.debugLineNum = 260;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvv4.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 261;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvv1(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeDelete(_vvvvvvvvvvvvvvvvv4(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeDelete(_vvvvvvvvvvvvvvvvv4(_vvvvvvvvvvvvvvvvvvvvv1,_parameters));
 };
...
public String  _vvvvvvvvvvvvvvvvv2(String _link) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeGet(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeGet(_vvvvvvvvvvvvvvvvvvvvv1);
 };
...
public String  _vvvvvvvvvvvvvvvvv3(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeGet(_vvvvvvvvvvvvvvvvv4(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeGet(_vvvvvvvvvvvvvvvvv4(_vvvvvvvvvvvvvvvvvvvvv1,_parameters));
 };
...
public String  _vvvvvvvvvvvvvvvvv4(String _link,String[] _parameters) throws Exception{
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvv5() throws Exception{
...
_b = __c.LoadBitmap(_vvv4._v0 /*String*/ ,_vvvvvvvvvvvvvvvvvvvv5);
 //BA.debugLineNum = 324;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 325;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvv6(int _width,int _height,boolean _keepaspectratio) throws Exception{
...
if (true) return __c.LoadBitmapResize(_vvv4._v0 /*String*/ ,_vvvvvvvvvvvvvvvvvvvv5,_width,_height,_keepaspectratio);
 //BA.debugLineNum = 334;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvv7(int _width,int _height) throws Exception{
...
if (true) return __c.LoadBitmapSample(_vvv4._v0 /*String*/ ,_vvvvvvvvvvvvvvvvvvvv5,_width,_height);
 //BA.debugLineNum = 330;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.streams.File.InputStreamWrapper  _vvvvvvvvvvvvvvvvv0() throws Exception{
...
_in = __c.File.OpenInput(_vvv4._v0 /*String*/ ,_vvvvvvvvvvvvvvvvvvvv5);
 //BA.debugLineNum = 341;BA.debugLine="Return In";
if (true) return _in;
 //BA.debugLineNum = 342;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest  _vvvvvvvvvvvvvvvvvv1() throws Exception{
 //BA.debugLineNum = 301;BA.debugLine="Public Sub GetRequest As OkHttpRequest";
 //BA.debugLineNum = 302;BA.debugLine="Return req";
if (true) return _vvvvvvvvvvvvvvvvvvvv6;
...
if (true) return _vvvvvvvvvvvvvvvvvv3("UTF8");
 //BA.debugLineNum = 284;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvv3(String _encoding) throws Exception{
...
_tr.Initialize2((java.io.InputStream)(__c.File.OpenInput(_vvv4._v0 /*String*/ ,_vvvvvvvvvvvvvvvvvvvv5).getObject()),_encoding);
...
public String  _vvvvvvvvvvvvvvvvvv4(String _link) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeHead(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvv6.InitializeHead(_vvvvvvvvvvvvvvvvvvvvv1);
 };
...
_vvvvvvvvvvvvvvvvvvv7 = _name;
 //BA.debugLineNum = 40;BA.debugLine="target = TargetModule";
_vvvvvvvvvvvvvvvvvvvv4 = _targetmodule;
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvvvvvvvvvvv5(anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _stream,boolean _empty) throws Exception{
...
public String  _vvvvvvvvvvvvvvvvvv6(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv6.InitializePatch2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvv6.InitializePatch2(_vvvvvvvvvvvvvvvvvvvvv1,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvv7(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvv6(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 85;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvv0(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv6.InitializePost2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvv6.InitializePost2(_vvvvvvvvvvvvvvvvvvvvv1,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvvv1(String _link,String _dir,String _filename) throws Exception{
int _length = 0;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_vvvvvvvvvvvvvvvvvv0(_link,_out.ToBytesArray());
 }else {
 //BA.debugLineNum = 203;BA.debugLine="req.InitializePost(Link, In, length)";
_vvvvvvvvvvvvvvvvvvvv6.InitializePost(_link,(java.io.InputStream)(_in.getObject()),_length);
...
public String  _vvvvvvvvvvvvvvvvvvv2(String _link,anywheresoftware.b4a.objects.collections.Map _namevalues,anywheresoftware.b4a.objects.collections.List _files) throws Exception{
String _boundary = "";
...
String _value = "";
String _s = "";
ESH.Hakkuraifu.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_empty = _vvvvvvvvvvvvvvvvvv5(_stream,_empty);
...
_fd = (ESH.Hakkuraifu.httpjob._multipartfiledata)(group17.Get(index17));
...
_vvvvvvvvvvvvvvvvvv0(_link,_stream.ToBytesArray());
 //BA.debugLineNum = 166;BA.debugLine="req.SetContentType(\"multipart/form-data; boundary";
_vvvvvvvvvvvvvvvvvvvv6.SetContentType("multipart/form-data; boundary="+_boundary);
 //BA.debugLineNum = 167;BA.debugLine="req.SetContentEncoding(\"UTF8\")";
_vvvvvvvvvvvvvvvvvvvv6.SetContentEncoding("UTF8");
 //BA.debugLineNum = 168;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvv3(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvv0(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 51;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvv4(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv6.InitializePut2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvv6.InitializePut2(_vvvvvvvvvvvvvvvvvvvvv1,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvvv5(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvvv4(_link,_text.getBytes("UTF8"));
...
__c.File.Delete(_vvv4._v0 /*String*/ ,_vvvvvvvvvvvvvvvvvvvv5);
