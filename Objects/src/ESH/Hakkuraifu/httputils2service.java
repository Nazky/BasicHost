...
public class httputils2service extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ESH.Hakkuraifu", "ESH.Hakkuraifu.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ESH.Hakkuraifu.httputils2service", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static anywheresoftware.b4h.okhttp.OkHttpClientWrapper _vvvvvvvvvvvvvvvvvvvvvvv3 = null;
public static anywheresoftware.b4a.objects.collections.Map _vvvvvvvvvvvvvvvvvvvvvvv2 = null;
public static String _v0 = "";
public static int _vvvvvvvvvvvvvvvvvvvvvvv4 = 0;
...
public static String  _vvvvvvvvvvvvvvvvvvvvvvv1(int _taskid,boolean _success,String _errormessage) throws Exception{
ESH.Hakkuraifu.httpjob _job = null;
...
_job = (ESH.Hakkuraifu.httpjob)(_vvvvvvvvvvvvvvvvvvvvvvv2.Get((Object)(_taskid)));
...
anywheresoftware.b4a.keywords.Common.LogImpl("67798790","HttpUtils2Service: job completed multiple times - "+BA.NumberToString(_taskid),0);
 //BA.debugLineNum = 149;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 151;BA.debugLine="TaskIdToJob.Remove(TaskId)";
_vvvvvvvvvvvvvvvvvvvvvvv2.Remove((Object)(_taskid));
 //BA.debugLineNum = 152;BA.debugLine="job.success = success";
_job._vvvvvvvvvvvvvvvvvvv0 /*boolean*/  = _success;
 //BA.debugLineNum = 153;BA.debugLine="job.errorMessage = errorMessage";
_job._vvvvvvvvvvvvvvvvvvvv3 /*String*/  = _errormessage;
 //BA.debugLineNum = 155;BA.debugLine="job.Complete(TaskId)";
_job._vvvvvvvvvvvvvvvv7 /*String*/ (_taskid);
...
anywheresoftware.b4a.keywords.Common.LogImpl("67733249",("ResponseError. Reason: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_reason))+", Response: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_response.getErrorResponse()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("67733253","HttpUtils2Service (hc_ResponseError): job completed multiple times - "+BA.NumberToString(_taskid),0);
 //BA.debugLineNum = 115;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 117;BA.debugLine="job.Response = Response";
_job._vvvvvvvvvvvvvvvvvvvv7 /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse*/  = _response;
...
_vvvvvvvvvvvvvvvvvvvvvvv1(_taskid,anywheresoftware.b4a.keywords.Common.False,_response.getErrorResponse());
 }else {
 //BA.debugLineNum = 121;BA.debugLine="CompleteJob(TaskId, False, Reason)";
_vvvvvvvvvvvvvvvvvvvvvvv1(_taskid,anywheresoftware.b4a.keywords.Common.False,_reason);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("67602179","HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(_v0,BA.NumberToString(_taskid),anywheresoftware.b4a.keywords.Common.False);
...
_vvvvvvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper();
...
_vvvvvvvvvvvvvvvvvvvvvvv1(_taskid,_success,"");
 }else {
 //BA.debugLineNum = 105;BA.debugLine="CompleteJob(TaskId, Success, LastException.Messa";
_vvvvvvvvvvvvvvvvvvvvvvv1(_taskid,_success,anywheresoftware.b4a.keywords.Common.LastException(processBA).getMessage());
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("67340039",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 //BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("67340040","Switching to File.DirInternal",0);
...
if (_vvvvvvvvvvvvvvvvvvvvvvv3.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 46;BA.debugLine="hc.Initialize(\"hc\")";
_vvvvvvvvvvvvvvvvvvvvvvv3.Initialize("hc");
 };
 //BA.debugLineNum = 54;BA.debugLine="TaskIdToJob.Initialize";
_vvvvvvvvvvvvvvvvvvvvvvv2.Initialize();
...
public static String  _submitjob(ESH.Hakkuraifu.httpjob _job) throws Exception{
int _taskid = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvv4 = (int) (_vvvvvvvvvvvvvvvvvvvvvvv4+1);
 //BA.debugLineNum = 74;BA.debugLine="Dim TaskId As Int = taskCounter";
_taskid = _vvvvvvvvvvvvvvvvvvvvvvv4;
 //BA.debugLineNum = 76;BA.debugLine="TaskIdToJob.Put(TaskId, job)";
_vvvvvvvvvvvvvvvvvvvvvvv2.Put((Object)(_taskid),(Object)(_job));
 //BA.debugLineNum = 77;BA.debugLine="If job.Username <> \"\" And job.Password <> \"\" Then";
if ((_job._vvvvvvvvvvvvvvvvvvvv1 /*String*/ ).equals("") == false && (_job._vvvvvvvvvvvvvvvvvvvv2 /*String*/ ).equals("") == false) { 
 //BA.debugLineNum = 78;BA.debugLine="hc.ExecuteCredentials(job.GetRequest, TaskId, jo";
_vvvvvvvvvvvvvvvvvvvvvvv3.ExecuteCredentials(processBA,_job._vvvvvvvvvvvvvvvvvv1 /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ (),_taskid,_job._vvvvvvvvvvvvvvvvvvvv1 /*String*/ ,_job._vvvvvvvvvvvvvvvvvvvv2 /*String*/ );
 }else {
 //BA.debugLineNum = 80;BA.debugLine="hc.Execute(job.GetRequest, TaskId)";
_vvvvvvvvvvvvvvvvvvvvvvv3.Execute(processBA,_job._vvvvvvvvvvvvvvvvvv1 /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ (),_taskid);
 };
